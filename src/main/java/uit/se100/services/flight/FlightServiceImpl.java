...
public class FlightServiceImpl implements FlightService {
    ...
    @Override
    public PageResponse<FlightSeat> getSeatAvailable(Long flightId, SeatClass seatClass, Pageable pageable) {
        Page<FlightSeat> flightSeats = flightSeatRepository.findBySeatClassAndFlightIdAndStatusOrderById(seatClass, SeatStatus.AVAILABLE, flightId, pageable);
     ...
     *                      <ul>
     *                        <li>Vé không tồn tại</li>
     *                        <li>Vé không ở trạng thái PAID</li>
     *                        <li>Ghế không tồn tại</li>
     *                        <li>Ghế không thuộc chuyến bay</li>
     *                        <li>Ghế không trống (trạng thái không phải AVAILABLE)</li>
     *                      </ul>
     */
    @Transactional
    @Override
    public FlightResponse assignSeat(Long flightId, AssignSeatRequest seatRequest) {
        ...
        if (ticket.getPassenger() != null && ticket.getPassenger().getUser() != null && !ticket.getPassenger().getUser().getEmail().equals(seatRequest.getPassengerEmail())) {
            throw new ApiException(ErrorCode.OPERATION_NOT_ALLOWED, "You are not allowed to assign seat for this ticket");
        }
