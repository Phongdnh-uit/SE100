...
class AuthControllerIntegrationTest {
  ...
  private User createAndSaveUser(String username, String email, String phone, String password, RoleEnum role) {
    User user = new User();
  ...
  private RegisterRequest createRegisterRequest(String username, String email, String phone, String password) {
  ...
  class RegisterTests {
    ...
    void shouldRegisterNewUserSuccessfully() throws Exception {
      RegisterRequest request = createRegisterRequest(TEST_USERNAME, TEST_EMAIL, TEST_PHONE, TEST_PASSWORD);
    ...
    void shouldReturnValidationErrorWhenUsernameIsBlank() throws Exception {
      RegisterRequest request = createRegisterRequest("", TEST_EMAIL, TEST_PHONE, TEST_PASSWORD);
    ...
    void shouldReturnValidationErrorWhenEmailIsInvalid() throws Exception {
      RegisterRequest request = createRegisterRequest(TEST_USERNAME, "invalid-email", TEST_PHONE, TEST_PASSWORD);
    ...
    void shouldReturnErrorWhenEmailAlreadyExists() throws Exception {
      ...
      createAndSaveUser("existinguser", TEST_EMAIL, "0987654321", TEST_PASSWORD, RoleEnum.PASSENGER);
    ...
    void shouldReturnErrorWhenUsernameAlreadyExists() throws Exception {
      // Create existing user
      createAndSaveUser(TEST_USERNAME, "existing@example.com", "0987654321", TEST_PASSWORD, RoleEnum.PASSENGER);
    ...
    void shouldReturnErrorWhenPhoneAlreadyExists() throws Exception {
      // Create existing user
      createAndSaveUser("existinguser", "existing@example.com", TEST_PHONE, TEST_PASSWORD, RoleEnum.PASSENGER);
  ...
  class LoginTests {
    ...
    void shouldLoginSuccessfullyWithUsername() throws Exception {
      createAndSaveUser(TEST_USERNAME, TEST_EMAIL, TEST_PHONE, TEST_PASSWORD, RoleEnum.PASSENGER);
    ...
    void shouldLoginWithDifferentRoles() throws Exception {
      createAndSaveUser("admin", "admin@example.com", "0111111111", TEST_PASSWORD, RoleEnum.ADMIN);
      createAndSaveUser("employee", "employee@example.com", "0222222222", TEST_PASSWORD, RoleEnum.EMPLOYEE);
      ...
      mockMvc
          .perform(
              post("/auth/login")
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createLoginRequest("admin", TEST_PASSWORD))))
          .andExpect(status().isOk())
      ...
      mockMvc
          .perform(
              post("/auth/login")
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createLoginRequest("employee", TEST_PASSWORD))))
          .andExpect(status().isOk())
  ...
  class ChangePasswordTests {
    ...
    void shouldChangePasswordSuccessfully() throws Exception {
      ...
      ChangePasswordRequest request = createChangePasswordRequest(TEST_PASSWORD, "newpassword123");
    ...
    void shouldAllowLoginWithNewPasswordAfterChange() throws Exception {
      ...
      mockMvc
          .perform(
              post("/auth/login")
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createLoginRequest(TEST_USERNAME, newPassword))))
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.data.accessToken", notNullValue()));
    }
    ...
    void shouldRejectOldPasswordAfterChange() throws Exception {
      ...
      mockMvc
          .perform(
              post("/auth/login")
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createLoginRequest(TEST_USERNAME, TEST_PASSWORD))))
          .andExpect(status().isUnauthorized());
    }
    ...
    void shouldReturnErrorWhenOldPasswordIsIncorrect() throws Exception {
      ...
      ChangePasswordRequest request = createChangePasswordRequest("wrongpassword", "newpassword123");
  ...
  class AuthWorkflowTests {
    ...
    @Test
    @DisplayName("Should perform complete auth workflow: register -> login -> get me -> change password -> logout")
    void shouldPerformCompleteAuthWorkflow() throws Exception {
      // 1. Register
      RegisterRequest registerRequest = createRegisterRequest(TEST_USERNAME, TEST_EMAIL, TEST_PHONE, TEST_PASSWORD);
      mockMvc
          .perform(
              post("/auth/register")
                  .contentType(MediaType.APPLICATION_JSON)
      ...
      mockMvc
          .perform(
              post("/auth/change-password")
                  ...
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createChangePasswordRequest(TEST_PASSWORD, "newpassword123"))))
          .andExpect(status().isOk());
      ...
      mockMvc
          .perform(
              post("/auth/login")
                  .contentType(MediaType.APPLICATION_JSON)
                  .content(objectMapper.writeValueAsString(createLoginRequest(TEST_USERNAME, "newpassword123"))))
          .andExpect(status().isOk())
          .andExpect(jsonPath("$.data.accessToken", notNullValue()));
    }
